...
// ══════════════════════════════
// Description info toggle (inside sidebar title)
// ══════════════════════════════
const btnInfo = document.getElementById('btn-info');
const descPanel = document.getElementById('desc-panel');
if (btnInfo && descPanel) {
